          ...
          <div className="flex items-center gap-1.5 ml-auto text-xs">
            ...
            {["all", "beginner", "intermediate", "advanced"].map((lvl) => (
              <button
                ...
                className={`px-2.5 py-1 rounded-lg text-xs capitalize border transition-all cursor-pointer ${
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {filteredPoses.map((pose) => (
          <div
            ...
            className="group bg-[#FAF8F4] rounded-3xl border border-[#E2DAD0] hover:border-[#4E6548]/70 hover:shadow-xl hover:shadow-[#4E6548]/10 hover:-translate-y-1.5 hover:scale-[1.015] active:scale-[0.99] transition-all duration-300 ease-out p-4 flex flex-col justify-between cursor-pointer"
          ...
          >
            <div>
              ...
              <div className="flex items-center justify-between text-xs text-[#7A887C] mb-1.5">
                ...
                <span className="text-[11px] text-[#8C7A6D] font-medium flex items-center gap-1">
              ...
              <div
                className="w-full h-[200px] bg-[#F3EDE2] rounded-2xl overflow-hidden border border-[#E4DCD0] group-hover:border-[#D6CAB8] transition-all duration-300 relative"
            ...
            <div className="flex items-center gap-2 mt-4 pt-3 border-t border-[#E8E0D2]">
              <button
                ...
                className="flex-1 py-2 px-3 rounded-xl bg-[#EDE5D8] hover:bg-[#DFD5C5] hover:shadow-xs active:scale-[0.98] text-[#334237] text-xs font-medium border border-[#D4C8B5] flex items-center justify-center gap-1.5 transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="py-2 px-3 rounded-xl bg-[#4E6548] hover:bg-[#3D5237] hover:shadow-sm active:scale-95 text-white text-xs font-medium flex items-center justify-center gap-1 transition-all cursor-pointer"
